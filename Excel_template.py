...
"Параметры":{
  ...
  "данные": [
    {"тип": "секция", "название": "Раздел КР - Стадия Р"},
    {"тип": "подсекция", "название": "03.04_Горизонтальные ж/б конструкции", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "данные", "Элементы модели": "03.04.01.01_Перекрытия ж/б монолитные", "Категория Revit": "Перекрытия", "Пример Класса IFC": "IfcSlab", "Код по классификатору": "03.04.01.01", "Описание по классификатору": "Плита перекрытия железобетонная монолитная", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "данные", "Элементы модели": "03.04.01.02_Балки ж/б монолитные", "Категория Revit": "Каркас несущий", "Пример Класса IFC": "IfcBeam", "Код по классификатору": "03.04.01.02", "Описание по классификатору": "Распорная система ограждения котлована", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "данные", "Элементы модели": "03.04.01.03_Лестницы ж/б монолитные", "Категория Revit": "Лестницы", "Пример Класса IFC": "IfcStair", "Код по классификатору": "03.04.01.03.01, 03.04.01.03.02", "Описание по классификатору": "Стена в грунте", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "подсекция", "название": "03.05_Металлические конструкции", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "данные", "Элементы модели": "03.05.01_Металлические конструкции несущие", "Категория Revit": "Каркас несущий; Несущие колонны", "Пример Класса IFC": "IfcBeam, IfcColumn, IfcMember", "Код по классификатору": "03.05.01.01, 03.05.01.03, 03.05.01.04", "Описание по классификатору": "Несущие металлические конструкции", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "данные", "Элементы модели": "03.05.02_Металлические ограждения и поручни", "Категория Revit": "Ограждения", "Пример Класса IFC": "IfcRailing", "Код по классификатору": "03.05.02", "Описание по классификатору": "Ограждение металлическое, поручень (перила)", "LOI": ["+", "+", "+", "+", "+"]}
  ]
},
"Адаптер":[
...
def export_common_excel(json_path: str, output_path: str) -> None:
    ...
    if params_data:
        ...
        for row_data in rows_data:
            ...
            if row_type == "секция":
                ws.merge_cells(start_row=out_row, start_column=1, end_row=out_row, end_column=total_cols)
                cell = ws.cell(out_row, 1, row_data.get("название", ""))
                cell.font = bold_font
                cell.fill = fill_gray
                cell.alignment = align_left_center
            elif row_type == "подсекция":
