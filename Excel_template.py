...
"Параметры":{
  ...
  "данные": [
    ...
    {"тип": "данные", "Элементы модели": "Шпунтовое ограждение котлована", "Категория Revit": "Фундамент несущей конструкции", "Пример Класса IFC": "IfcPile", "Код по классификатору": "НЦ.ОК.1, НЦ.ОК.2, НЦ.ОК.3", "Описание по классификатору": "Ограждение котлована из шпунта Ларсена; Ограждение котлована из стальных труб; Ограждение котлована из свай", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "данные", "Элементы модели": "Распорная система", "Категория Revit": "Каркас несущий, Несущие колонны", "Пример Класса IFC": "IfcPile", "Код по классификатору": "НЦ.ОК.4", "Описание по классификатору": "Распорная система ограждения котлована", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "данные", "Элементы модели": "Стена в грунте", "Категория Revit": "Стены", "Пример Класса IFC": "IfcFooting", "Код по классификатору": "НЦ.ОК.5", "Описание по классификатору": "Стена в грунте", "LOI": ["+", "+", "+", "+", "+"]}
  ]
},
"Адаптер":[
