...
"Параметры":{
  ...
  "данные": [
    ...
    {"тип": "данные", "Элементы модели": "03.03.01.01_Стены ж/б монолитные", "Категория Revit": "Стены", "Пример Класса IFC": "IfcWall", "Код по классификатору": "03.03.01.01", "Описание по классификатору": "Стена железобетонная монолитная", "LOI": ["+", "+", "+", "+", "+"]},
    ...
    {"тип": "данные", "Элементы модели": "04.02.01_Воздуховоды", "Категория Revit": "Воздуховоды", "Пример Класса IFC": "IfcDuctSegment", "Код по классификатору": "04.02.01.01, 04.02.01.02, 04.02.01.07", "Описание по классификатору": "Воздуховоды систем вентиляции", "LOI": ["+", "+", "+", "+", "+"]},
    ...
    {"тип": "данные", "Элементы модели": "04.02.04_Воздухораспределительные устройства", "Категория Revit": "Воздухораспределители", "Пример Класса IFC": "IfcAirTerminal", "Код по классификатору": "04.02.04.03, 04.02.04.04", "Описание по классификатору": "Воздухораспределительные устройства", "LOI": ["+", "+", "+", "+", "+"]},
    {"тип": "данные", "Элементы модели": "04.02.05_Арматура воздуховодов", "Категория Revit": "Арматура воздуховодов", "Пример Класса IFC": "IfcDuctFitting", "Код по классификатору": "04.02.05.01, 04.02.05.03, 04.02.05.05", "Описание по классификатору": "Арматура воздуховодов", "LOI": ["+", "+", "+", "+", "+"]}
  ]
},
"Адаптер":[
