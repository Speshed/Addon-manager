...
py -3 -m PyInstaller --noconfirm --onefile --windowed --name "%APP_NAME%" %ICON_ARG% --add-data "icon;icon" --add-data "shared;shared" --add-data "Adapters;Adapters" --add-data "Sets;Sets" --add-data "Matrix;Matrix" --add-data "Validator;Validator" --add-data "Viewer;Viewer" --add-data "Sync;Sync" --add-data "importxml;importxml" --hidden-import shared.app_common --hidden-import shared.dialogs --hidden-import shared.theme_toggle --hidden-import shared.excel_parser --hidden-import shared.excel_template --hidden-import Adapters.ui --hidden-import Sets.ui --hidden-import Matrix.ui --hidden-import Validator.ui --hidden-import Viewer.ui --hidden-import Viewer.keycloak_auth --hidden-import Sync.ui --hidden-import Sync.odbc --hidden-import Sync.tls --hidden-import importxml.XML "%ENTRY%"
